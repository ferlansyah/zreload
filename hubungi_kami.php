...
if (isset($_POST['submit']))
{
    ...
    if (empty($err))
    {
        $q = $pdo->prepare("INSERT INTO feedback (nama,email, no_hp, inv_id, pesan, tanggal) VALUES (?, ?, ?, ?, ?, ?)");
        $q->execute(array(
            $nama,
            $email,
            $no_hp,
...
<div class="row">
  <div class="col-sm-8">
    ...
    <form class="form-horizontal" method="post" action="<?php echo SITE_URL ?>hubungi_kami.php">
      <div class="form-group">
        ...
        <div class="col-sm-10">
          <input type="text" class="form-control" style="text-transform:uppercase" name="nama" id="nama" maxlength="12" required="required" value="<?php echo __e($nama) ?>"/>
        </div>
      </div>
      <div class="form-group">
        ...
        <div class="col-sm-10">
          <input type="text" class="form-control"  name="email" id="email" maxlength="40" placeholder="admin@gmail.com" required="required" value="<?php echo __e($no_hp) ?>"/>
        </div>
      </div>
      <div class="form-group">
      ...
      <div class="form-group">
        ...
        <div class="col-sm-10">
          <input type="text" class="form-control" style="text-transform:uppercase" name="inv_id" id="inv_id" maxlength="32" required="required" value="<?php echo __e($inv_id) ?>"/>
        </div>
      </div>
      <?php endif; ?>
      <div class="form-group">
  ...
  <div class="col-sm-4">
    ...
    <div class="well well-sm">
        <dl>
            <dt>ZReload</dt>
            <dd>Jalan Assalam 3, Ujung Harapan Bekasi </dd>
        </dl>
        <a href="https://tawk.to/chat/58dd2808f97dd14875f5adf6/default/?$_tawk_popout=true" target="popup" onclick="window.open('https://tawk.to/chat/58dd2808f97dd14875f5adf6/default/?$_tawk_popout=true','popup','width=600,height=600'); return false;">
        <button class="btn btn-primary">Live Chat Dengan Customer Service</button>
        </a>
    </div>
  </div>
</div>
