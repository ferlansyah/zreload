...
echo '<h3 class="page-header">Admin Panel ZReload</h3>';
echo '<div class="row">';
...
echo '<div class="panel panel-default" id="produk">' .
    '<div class="panel-heading"><strong><i class="glyphicon glyphicon-book"></i> Produk</strong>' .
    '</div>';
...
echo '<div class="panel panel-default">' .
    ...
    '?c=setelan"><i class="fas fa-sliders-h"></i> Umum</a>' . '<a class="list-group-item" href="' . ADM_URL .
    '?c=setelan&amp;a=saldo_pin"><i class="fas fa-money-check-alt"></i> Saldo & PIN</a>' .
    '<a class="list-group-item" href="' . ADM_URL .
    '?c=setelan&amp;a=produk"><i class="fas fa-cart-arrow-down"></i> Produk & Format Transaksi</a><a class="list-group-item" href="' .
    ADM_URL . '?c=setelan&amp;a=metode_pembayaran"><i class="fas fa-university"></i> Metode Pembayaran</a>' .
    '<a class="list-group-item" href="' . ADM_URL .
    '?c=setelan&amp;a=envaya_sms"><i class="fas fa-comments"></i> Envaya SMS</a>' . '</div></div></div></div>';
echo '<div><a class="btn btn-danger" href="' . ADM_URL . '?c=keluar">Keluar (' .
    __e($admin->username) . ') <i class="fas fa-sign-out-alt"></i></a></div>';
