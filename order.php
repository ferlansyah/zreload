...
if (isset($_POST['submit']))
{
    ...
    $id_email = isset($_REQUEST['id_email']) ? $_REQUEST['id_email'] : '';
...
<div class="row">
  <div class="col-sm-8">
    <table class="table table-striped table-bordered">
      <tbody>
        ...
        <?php endif;?>
        <?php if ($op->op_produk == 'voucher_game'):?>
        <tr>
          <td>
            Alamat Email
          </td>
  ...
  <div class="col-sm-4">
    ...
    <div class="alert alert-success">
      Khusus Pembelian Premium Account pastikan Nomor handphone yang anda masukan terhubung ke WhatsApp.
    </div>
    <?php endif;?>
    <form method="post" action="<?php echo SITE_URL;?>order.php">
      ...
      <input type="hidden" name="id_email" value="<?php echo __e($id_email);?>"/>
      ...
      <div class="form-group">
        ...
        <i class="fas fa-cash-register"></i> Bayar Pesanan
        </button>
        <button class="btn btn-danger btn-lg btn-block" type="submit" name="submit" onclick="history.go(-1);">
        <i class="fas fa-window-close"></i> Batalkan Pesanan
        </button>
      </div>
    </form>
  </div>
    ...
    <li class="timeline-inverted">
        ...
        <div class="timeline-panel">
          ...
          <div class="timeline-body">
            <p>
              Kami menjamin transaksi & data anda aman 100%.
            </p>
          </div>
        </div>
      </li>
      <li class="timeline-inverted">
        ...
        <div class="timeline-panel">
          ...
          <div class="timeline-body">
            <p>
              Pilih Produk Voucher / TokenPLN / Paket Data / Voucher Game / Premium Account.
            </p>
          </div>
        </div>
      </li>
      <li class="timeline-inverted">
        ...
        <div class="timeline-panel">
          ...
          <div class="timeline-body">
            <p>
              Lakukan Pembayaran dengan metode pembayaran yang tersedia maksimal <?php echo $set['jam_pembayaran'];?> Jam.
            </p>
          </div>
        </div>
      </li>
      <li class="timeline-inverted">
        ...
        <div class="timeline-panel">
          ...
          <div class="timeline-body">
            <p>
              Anda tidak perlu melakukan konfirmasi pembayaran, sistem akan otomatis mengecek pembayaran anda.
            </p>
          </div>
        </div>
      </li>
...
$foot = '<script>$("#operator").change(function() {
                ...
                if (dataProduk.voucher_game != undefined && dataProduk.voucher_game[selectedValue] != undefined) {
                  $("#data_value1").html(\'<div class="form-group"><label for="id_email">Email</label><input type="text" class="form-control" name="id_email" id="id_email" maxlength="40" minlength="5" required/></div>\');
                }
                else {
                    $("#data_value1").html("");
                }
